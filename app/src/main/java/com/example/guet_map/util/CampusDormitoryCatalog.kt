...
object CampusDormitoryCatalog {
    ...
    val zones: List<DormZone> = listOf(
        DormZone("泾苑", 'A', "桂林电子科技大学花江校区泾苑", listOf("泾苑", "A区", "a区", "宿舍A区", "花江A区")),
        DormZone("清苑", 'B', "桂林电子科技大学花江校区清苑", listOf("清苑", "B区", "b区", "宿舍B区", "花江B区")),
        DormZone("淑苑", 'C', "桂林电子科技大学花江校区淑苑", listOf("淑苑", "C区", "c区", "宿舍C区", "花江C区")),
        DormZone("润苑", 'D', "桂林电子科技大学花江校区润苑", listOf("润苑", "D区", "d区", "宿舍D区", "花江D区")),
        DormZone("溶苑", 'F', "桂林电子科技大学花江校区溶苑", listOf("溶苑", "F区", "f区", "宿舍F区", "花江F区"))
    )
